...
Casbin authz is an authorization middleware for [Revel](https://github.com/caeril/frevel/revel), it's based on [https://github.com/casbin/casbin](https://github.com/casbin/casbin).
...
import (
	...
	"github.com/caeril/frevel/modules/auth/casbin"
)
