...
import (
	...
	"github.com/caeril/frevel/config"
	"errors"
	"fmt"
	"path/filepath"
	"sort"
...
var RevelImportPath = "github.com/caeril/frevel/revel"
var RevelModulesImportPath = "github.com/caeril/frevel/modules"
...
func (rp *RevelContainer) addModulePaths(name, importPath, modulePath string) {
	...
	if importPath == rp.Config.StringDefault("module.testrunner", "github.com/caeril/frevel/modules/testrunner") {
