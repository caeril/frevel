...
import (
	...
	_ "github.com/caeril/frevel/cmd/parser"
	"github.com/caeril/frevel/cmd/utils"
	"github.com/caeril/frevel/cmd/parser2"
	"github.com/caeril/frevel/cmd/parser"
)
...
import (
	"reflect"
	"github.com/caeril/frevel/revel"{{range $k, $v := $.ImportPaths}}
	{{$v}} "{{$k}}"{{end}}
	"github.com/caeril/frevel/revel/testing"
)
...
import "github.com/caeril/frevel/revel"
