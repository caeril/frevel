...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/caeril/frevel/cmd/harness"
...
For example, to run the chat room sample application:
    ...
    revel run -m dev github.com/caeril/frevel/examples/chat
...
You can set a port as well.  For example:
    ...
    revel run -m prod -p 8080 github.com/caeril/frevel/examples/chat `,
}
