...
import (
	...
	"github.com/caeril/frevel/cmd/revel"
...
func TestNew(t *testing.T) {
	...
	t.Run("Skeleton-Git", func(t *testing.T) {
		...
		c.New.SkeletonPath = "git://github.com/caeril/frevel/skeletons:basicnsadnsak"
		...
		c.New.SkeletonPath = "git://github.com/caeril/frevel/skeletons:basic/bootstrap4"
